...
- Add each of the following Regexs:
  ...
  - ^https://meetinghelper\.com/viewQuery\?parentIndex\=[0-3]\&childIndex\=\d\d?\&operatorIndex\=[0-3]\&queryValue\=(S|D|T|I).+?\&queryText(\=.+)?\&birthDate\=(true|false)\&descending\=(true|false)\&orderBy\=.+$
